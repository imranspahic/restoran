...
--
-- Temporary view structure for view `cijenanarudžbe`
--

DROP TABLE IF EXISTS `cijenanarudžbe`;
/*!50001 DROP VIEW IF EXISTS `cijenanarudžbe`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `cijenanarudžbe` AS SELECT 
 1 AS `idNarudžbe`,
 1 AS `Cijena narudžbe (KM)`*/;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER provjeriNarudžbu
BEFORE INSERT ON detalji_narudžbe
FOR EACH ROW
BEGIN
	DECLARE porukaGreške varchar(255);
    IF NEW.idNarudžbe NOT IN(
		SELECT n.idNarudžbe
		FROM narudžbe n
	)
    THEN SET porukaGreške = 'Greška: narudžba ne postoji!';
		SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = porukaGreške;
	END IF;
END */;;
DELIMITER ;
...
--
-- Temporary view structure for view `korisničkipodacinarudžbe`
--

DROP TABLE IF EXISTS `korisničkipodacinarudžbe`;
/*!50001 DROP VIEW IF EXISTS `korisničkipodacinarudžbe`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `korisničkipodacinarudžbe` AS SELECT 
 1 AS `idNarudžbe`,
 1 AS `id`,
 1 AS `ime`,
 1 AS `prezime`,
...
CREATE TABLE `kuponi` (
  ...
  `iznosPopusta` varchar(10) NOT NULL,
...
CREATE TABLE `narudžbe` (
  ...
  KEY `cidRestorana` (`idRestorana`),
  CONSTRAINT `cidRestorana` FOREIGN KEY (`idRestorana`) REFERENCES `restorani` (`idRestorana`) ON DELETE CASCADE,
...
INSERT INTO `narudžbe` VALUES (1127502,'hrxy4lh13pu7d5roonrg','dpgj0jqmzxds9319kva1',NULL,20,'na čekanju','2020-04-18 16:47:00'),(1256077,'2d682j4pnb3ha4el9900','dpgj0jqmzxds9319kva1',12162,20,'prihvaćeno','2020-09-15 08:50:00'),(1382204,'he6kd7hocc3tcs0ax902','dpgj0jqmzxds9319kva1',NULL,30,'prihvaćeno','2020-11-26 09:52:00'),(1841596,'85xb5y8f33ul3js2p1ru','dpgj0jqmzxds9319kva1',NULL,10,'odbijeno','2020-06-18 12:57:00'),(1918535,'8p0uj79n7ajq5e5wfutd','dpgj0jqmzxds9319kva1',16484,80,'na čekanju','2020-11-03 09:25:00'),(1923547,'85xb5y8f33ul3js2p1ru','dpgj0jqmzxds9319kva1',32608,30,'odbijeno','2020-03-25 13:27:00'),(2186625,'jtyz6mi34rv8e7tpqosi','dpgj0jqmzxds9319kva1',NULL,30,'prihvaćeno','2020-10-09 15:31:00'),(2194996,'8jmoiza5uhjxhktrfo66','dpgj0jqmzxds9319kva1',NULL,20,'prihvaćeno','2020-03-27 12:38:00'),(2208793,'c42ya8o3koluw6lmszwg','dpgj0jqmzxds9319kva1',42647,35,'na čekanju','2020-12-02 17:04:00'),(3237246,'2d682j4pnb3ha4el9900','dpgj0jqmzxds9319kva1',NULL,10,'odbijeno','2020-10-19 06:20:00'),(3309934,'6oyti67l58ip4d4vetsc','dpgj0jqmzxds9
(8710868,'r4ivrk6ccbf4z4pyy9ce','49i2f1iucu2yaze3bfck',2647,20,'na čekanju','2020-12-19 12:49:00'),(9034141,'pv4n1m3fxfnjwk0pw0x5','49i2f1iucu2yaze3bfck',1767,10,'prihvaćeno','2020-10-19 09:41:00'),(9114179,'0c25n5d9mkzevqnv7hwo','49i2f1iucu2yaze3bfck',6484,60,'prihvaćeno','2020-09-03 16:25:00'),(9122893,'a20w97n2jnksu5klryuf','49i2f1iucu2yaze3bfck',2647,10,'odbijeno','2020-09-09 12:41:00'),(9243220,'uswmhm7gfqtvp6hc1oq4','49i2f1iucu2yaze3bfck',NULL,20,'prihvaćeno','2020-08-15 08:20:00'),(9252683,'5ave4fhjevf0pmetmfpw','05gzy924yg0lk7zd70ah',NULL,20,'prihvaćeno','2020-09-11 11:30:00'),(9380385,'6oyti67l58ip4d4vetsc','05gzy924yg0lk7zd70ah',NULL,10,'odbijeno','2020-06-28 12:59:00'),(9453152,'jtyz6mi34rv8e7tpqosi','05gzy924yg0lk7zd70ah',NULL,50,'prihvaćeno','2020-12-01 08:31:00'),(9478089,'jtyz6mi34rv8e7tpqosi','05gzy924yg0lk7zd70ah',NULL,15,'odbijeno','2020-11-25 16:50:00'),(9886969,'c42ya8o3koluw6lmszwg','eb3hb4el990rapy8v7x0',NULL,30,'prihvaćeno','2020-11-09 16:11:00');
...
--
-- Temporary view structure for view `narudžbesapopustom`
--

DROP TABLE IF EXISTS `narudžbesapopustom`;
/*!50001 DROP VIEW IF EXISTS `narudžbesapopustom`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `narudžbesapopustom` AS SELECT 
 1 AS `idNarudžbe`,
 1 AS `adresaIsporuke`,
 1 AS `vrijemeIsporuke`,
 1 AS `statusNarudžbe`,
 1 AS `datumNarudžbe`,
 1 AS `brojKupona`,
 1 AS `statusKupona`,
...
--
-- Temporary view structure for view `restorannarudžbe`
--

DROP TABLE IF EXISTS `restorannarudžbe`;
/*!50001 DROP VIEW IF EXISTS `restorannarudžbe`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `restorannarudžbe` AS SELECT 
 1 AS `idNarudžbe`,
 1 AS `imeRestorana`*/;
SET character_set_client = @saved_cs_client;

--
-- Dumping events for database 'restoran'
--

--
-- Dumping routines for database 'restoran'
--
/*!50003 DROP PROCEDURE IF EXISTS `dobijPrihod` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `dobijPrihod`(IN početak DATETIME, IN kraj DATETIME)
BEGIN
	SELECT CONCAT(CAST(COALESCE(ROUND(SUM(dn.količina * p.cijenaProizvoda),2), 0.00) AS CHAR(20)),' ','KM') 
    AS "Prihod"
	FROM narudžbe n 
    INNER JOIN detalji_narudžbe dn
    USING (idNarudžbe)
    INNER JOIN proizvodi p 
    USING (šifraProizvoda)
    WHERE n.datumNarudžbe BETWEEN početak AND kraj;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `mjesečniPrihod` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `mjesečniPrihod`(IN mjesec INT)
BEGIN
	SELECT CONCAT(CAST( COALESCE(ROUND(SUM(dn.količina * p.cijenaProizvoda),2), 0.00) AS CHAR(20)),' ','KM') 
    AS "Mjesečni prihod"
	FROM narudžbe n 
    ...
    INNER JOIN proizvodi p 
    USING (šifraProizvoda)
    WHERE MONTH(n.datumNarudžbe) = mjesec;
...
--
-- Final view structure for view `cijenanarudžbe`
--
...
/*!50001 VIEW `cijenanarudžbe` AS select `n`.`idNarudžbe` AS `idNarudžbe`,round((sum((`dn`.`količina` * `p`.`cijenaProizvoda`)) * (1 - (coalesce(`np`.`iznosPopusta`,'0') / 100))),2) AS `Cijena narudžbe (KM)` from (((`narudžbe` `n` join `detalji_narudžbe` `dn` on((`n`.`idNarudžbe` = `dn`.`idNarudžbe`))) join `proizvodi` `p` on((`dn`.`šifraProizvoda` = `p`.`šifraProizvoda`))) left join `narudžbesapopustom` `np` on((`n`.`idNarudžbe` = `np`.`idNarudžbe`))) group by `n`.`idNarudžbe` order by `Cijena narudžbe (KM)` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `korisničkipodacinarudžbe`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `korisničkipodacinarudžbe` AS select `n`.`idNarudžbe` AS `idNarudžbe`,`k`.`id` AS `id`,`k`.`ime` AS `ime`,`k`.`prezime` AS `prezime`,`k`.`email` AS `email`,`k`.`brojTelefona` AS `brojTelefona`,`a`.`ulica` AS `ulica`,`a`.`brojUlice` AS `brojUlice`,`a`.`grad` AS `grad`,`a`.`region` AS `region`,`a`.`poštanskiBroj` AS `poštanskiBroj`,`a`.`upute` AS `upute` from ((`narudžbe` `n` join `adrese` `a` on((`n`.`adresaIsporuke` = `a`.`idAdrese`))) join `korisnici` `k` on((`a`.`idKorisnika` = `k`.`id`))) order by `n`.`idNarudžbe` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `narudžbesapopustom`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `narudžbesapopustom` AS select `n`.`idNarudžbe` AS `idNarudžbe`,`n`.`adresaIsporuke` AS `adresaIsporuke`,`n`.`vrijemeIsporuke` AS `vrijemeIsporuke`,`n`.`statusNarudžbe` AS `statusNarudžbe`,`n`.`datumNarudžbe` AS `datumNarudžbe`,`k`.`brojKupona` AS `brojKupona`,`k`.`statusKupona` AS `statusKupona`,`k`.`datumKreiranja` AS `datumKreiranja`,`k`.`datumIsteka` AS `datumIsteka`,`k`.`iznosPopusta` AS `iznosPopusta`,`k`.`imeAkcijskePonude` AS `imeAkcijskePonude` from (`narudžbe` `n` join `kuponi` `k` on((`n`.`brojKupona` = `k`.`brojKupona`))) order by `n`.`idNarudžbe` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `restorannarudžbe`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `restorannarudžbe` AS select `n`.`idNarudžbe` AS `idNarudžbe`,`r`.`imeRestorana` AS `imeRestorana` from (`narudžbe` `n` join `restorani` `r` on((`n`.`idRestorana` = `r`.`idRestorana`))) order by `n`.`idNarudžbe` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2020-12-23 13:09:59
